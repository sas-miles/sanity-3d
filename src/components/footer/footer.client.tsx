...
export default function FooterClient({ nav, settings }: FooterClientProps) {
  ...
  return (
    <footer className="bg-muted">
      <div className="overflow-hidden rounded-tl-[10px] rounded-tr-[20px] bg-zinc-900 text-white md:rounded-tl-[20px] md:rounded-tr-[20px] lg:rounded-tl-[50px] lg:rounded-tr-[50px]">
        <PreFooter />
