...
export function DoubleStreetLight({ position = [0, 0, 0], rotation = [0, 0, 0], scale = [1, 1, 1], ...props }: StreetLightProps) {
...
export function SingleStreetLight({ position = [0, 0, 0], rotation = [0, 0, 0], scale = [1, 1, 1], ...props }: StreetLightProps) {
  const { nodes, materials } = useGLTF('/models/StreetLights.glb') as GLTFResult
  return (
    <group position={position} rotation={rotation} scale={scale} {...props} dispose={null}>
      <mesh
...
export function ClassicStreetLight({ position = [0, 0, 0], rotation = [0, 0, 0], scale = [1, 1, 1], ...props }: StreetLightProps) {
  const { nodes, materials } = useGLTF('/models/StreetLights.glb') as GLTFResult
  return (
    <group position={position} rotation={rotation} scale={scale} {...props} dispose={null}>
      <mesh
