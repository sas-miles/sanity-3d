...
const PALM_POSITIONS: Record<string, PalmPosition[]> = {
  ...
  eastEntrance: [
    { position: [21.474, 2.667, 63.365] },
    { position: [1.009, 2.667, 63.365] },
    { position: [-28.656, 2.667, 63.365] },
    { position: [-49.609, 2.667, 63.365] },
  ],
  northernArea: [
    { position: [-27.523, 2.667, -5.028] },
    { position: [-49.609, 2.667, -5.028] },
    { position: [20.846, 2.667, -5.028] },
    { position: [-2.571, 2.667, -5.028] },
    { position: [-49.609, 2.667, 31.513] },
  ],
  westernBorder: [
    { position: [-78.808, 2.667, 63.365] },
    { position: [-93.991, 2.667, 63.365] },
    { position: [-69.585, 2.667, 88.318] },
    { position: [-84.769, 2.667, 88.318] },
  ...
  southernPath: [
    { position: [5.854, 2.667, 131.785] },
    { position: [5.854, 2.667, 118.174] },
    { position: [5.175, 2.667, 105.85] },
    { position: [1.542, 2.667, 92.141] },
  ],
  southEastCluster: [
    { position: [-20.069, 2.667, 113.367] },
    { position: [-20.069, 2.667, 97.919] },
    {
      position: [-57.518, 2.667, 116.313],
      rotation: [0, -0.644, 0],
      scale: 0.906,
    },
    {
      position: [-46.344, 2.667, 116.313],
      rotation: [0, -0.644, 0],
      scale: 0.906,
    },
    {
      position: [-57.518, 2.667, 99.567],
      rotation: [0, -0.644, 0],
      scale: 0.906,
    },
    {
      position: [-46.344, 2.667, 99.567],
      rotation: [0, -0.644, 0],
      scale: 0.906,
    },
  ],
...
export function Instances({ children, ...props }: InstancesProps) {
  const { nodes } = useGLTF("/models/tree-large.glb") as GLTFResult;
